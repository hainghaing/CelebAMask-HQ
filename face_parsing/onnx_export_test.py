...
class Exporter(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        resize = transforms.Resize((w, h), interpolation=PIL.Image.LINEAR)
        
        return resize(y).unsqueeze(-1)
...
if __name__ == "__main__":
    ...
    dummy_input = torch.zeros((512, 512, 4)).to(torch.uint8)
    
    file_path = "onnx/mask.onnx"
